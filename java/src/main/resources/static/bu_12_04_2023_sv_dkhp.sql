...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 12, 2023 at 04:24 PM
...
(7, '2023-04-17', 'HOC_MOI', '2023-04-17', '2023-04-30', 0, 38, 'DHKTPM1ATT', 'DANG_CHO_SINH_VIEN_DANG_KY', 1, 11, 1000001);
...
(1, 'https://res.cloudinary.com/dopzctbyo/image/upload/v1649587847/sample.jpg', '079201030774', 'DAI_HOC', 'HA_NOI', 'CHAT_LUONG_CAO', '60/122 KP8 Phường TCH Quận 12 HCM', 'NAM', 'Học Sinh A', '2020-01-01', '2019-01-01', 'HỒ CHÍ MINH', '0338188506', 24510550, b'0', 1, 4);
...
(9, 'T12', 'Lớp này dành cho DH12 T10-12 T5', 'LT', '2023-04-05', '2023-04-30', 0, 'V5.03', b'0', 'T5', 'T10', 6, 21, 1);
...
(1, 0, 1, 1, 'T3', 'HOC THUC HANH NHA CAC BAN NHO DEM LAPTOP', 'TH', '2023-02-12', '2023-02-28', 1, 'H6.01', b'0', 'T5', 'T1'),
...
(1, 'eyJhbGciOiJIUzUxMiJ9.eyJzdWIiOiJzdjEiLCJleHAiOjE2ODExNTUxMDIsImlhdCI6MTY4MTEzNzEwMn0.jfhaFQZez3l09SnSmRmV8fs8G7FojwEsY9cdP9WZVROEyVMdi-1LFt8v4dWIgsP0CHARk0zcQfBY4XL4BoSQ9g', '2023-02-04 14:46:52', 4),
(2, 'eyJhbGciOiJIUzUxMiJ9.eyJzdWIiOiJndjEiLCJleHAiOjE2ODExNjE1MDQsImlhdCI6MTY4MTE0MzUwNH0.92wd4nTzrn49QcJ89LVZtYU77XZbPaguUVphiGGKuBVMWgq-UqjtLSAeX1Q27b4vNp0pmeRZKJCVH-w75cIqyA', '2023-02-04 20:15:46', 1),
(3, 'eyJhbGciOiJIUzUxMiJ9.eyJzdWIiOiJudjEiLCJleHAiOjE2ODExNjIxNDgsImlhdCI6MTY4MTE0NDE0OH0.tRxoMXtD3oyJndngsLFFNPv8BjnhXMy_gWa2x1SwO3phlVJBK7eLt5ycpcFs8Veq5Gk0PZd4vHpW07cPPKZ8fw', '2023-02-05 01:08:03', 2);
...
--
ALTER TABLE `lop_hoc_phan`
  MODIFY `ma_lop_hoc_phan` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
...
--
ALTER TABLE `phieu_thu`
  MODIFY `ma_phieu_thu` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=31;
...
--
ALTER TABLE `thoi_khoa_bieu`
  MODIFY `ma_thoi_khoa_bieu` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;

--
-- AUTO_INCREMENT for table `thoi_khoa_bieu_con`
--
ALTER TABLE `thoi_khoa_bieu_con`
  MODIFY `ma_thoi_khoa_bieu_con` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
