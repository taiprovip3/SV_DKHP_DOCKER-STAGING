...
CREATE TABLE `chuong_trinh_khung` (
  `id` bigint NOT NULL,
  `done` bit(1) NOT NULL,
  `ma_mon_hoc` bigint DEFAULT NULL,
  `ma_sinh_vien` bigint DEFAULT NULL
...
CREATE TABLE `cong_no` (
  ...
  `ma_lop_hoc_phan` bigint DEFAULT NULL,
  `ma_mon_hoc` bigint NOT NULL,
...
(1, 0, 0, 0, 0, 0, 'CHUA_NOP', 8, 1000081, 1);
...
CREATE TABLE `diem` (
  ...
  `pass` bit(1) NOT NULL,
  `xep_loai` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `ma_lop_hoc_phan` bigint DEFAULT NULL,
  `ma_sinh_vien` bigint NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(1, 0, 5, 6, 5, 2, 4, 4, 7, 7, 6, 0, NULL, b'1', NULL, 2, 1),
(30, 0, 10, 0, 5, 0, 4, 6, 7, 8, 6, 0, NULL, b'0', NULL, 1, 1);
...
CREATE TABLE `giao_vien` (
  `ma_giao_vien` bigint NOT NULL,
  `dia_chi` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `gioi_tinh` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `loai_giao_vien` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `ngay_sinh` date DEFAULT NULL,
  `sdt` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `ten_giao_vien` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `ma_tai_khoan` bigint DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `hoc_ky` (
  ...
  `ten_hoc_ky` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `khoa_hoc` (
  `ma_khoa_hoc` bigint NOT NULL,
  `nam_bat_dau` int NOT NULL,
  `nam_ket_thuc` int NOT NULL,
  `ten_khoa_hoc` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `lop_hoc_phan` (
  `ma_lop_hoc_phan` bigint NOT NULL,
  `han_nop_hoc_phi` date DEFAULT NULL,
  `loai_hoc` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `ngay_bat_dau` date DEFAULT NULL,
  `ngay_ket_thuc` date DEFAULT NULL,
  `so_luong` int NOT NULL,
  `so_luong_max` int NOT NULL,
  `ten_lop_hoc_phan` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `trang_thai` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `ma_giao_vien` bigint DEFAULT NULL,
  `ma_khoa_hoc` bigint DEFAULT NULL,
  `ma_mon_hoc` bigint DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(1, '2023-01-12', 'HOC_MOI', '2023-01-26', '2023-01-28', 1, 23, 'DHKTPM15CTT', 'DANG_CHO_SINH_VIEN_DANG_KY', 1, 8, 1000082),
(2, '2023-01-31', 'HOC_MOI', '2023-02-08', '2023-02-23', 1, 35, 'DHKTPM1ATT', 'DA_KHOA', 1, 1, 1000001),
(3, '2023-02-04', 'HOC_MOI', '2023-02-05', '2023-02-11', 0, 34, 'DHKTPM15CTT', 'DANG_CHO_SINH_VIEN_DANG_KY', 1, 1, 1000001),
(4, '2023-02-04', 'HOC_MOI', '2023-02-05', '2023-02-11', 1, 44, 'DHKTPM15BTT', 'DANG_CHO_SINH_VIEN_DANG_KY', 1, 1, 1000002),
(5, '2023-01-02', 'HOC_MOI', '2023-01-05', '2023-01-23', 0, 33, 'DHKTPM15ATT', 'DANG_CHO_SINH_VIEN_DANG_KY', 1, 8, 1000081),
(6, '2023-01-01', 'HOC_MOI', '2023-01-02', '2023-01-28', 0, 21, 'DHKTPM1ATT', 'DANG_CHO_SINH_VIEN_DANG_KY', 1, 8, 1000081),
(7, '2023-01-01', 'HOC_MOI', '2023-01-02', '2023-01-28', 0, 55, 'DHKTPM15DTT', 'DANG_CHO_SINH_VIEN_DANG_KY', 1, 8, 1000081),
(8, '2023-02-01', 'HOC_MOI', '2023-02-02', '2023-02-28', 1, 55, 'DHKTPM15DTT', 'DANG_CHO_SINH_VIEN_DANG_KY', 1, 8, 1000081);
...
CREATE TABLE `mon_hoc` (
  ...
  `loai_mon` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `ma_mon_yeu_cau` bigint NOT NULL,
  `nhom_mon` int NOT NULL,
  `so_tietlt` int NOT NULL,
  `so_tietth` int NOT NULL,
  `so_tin_chi` int NOT NULL,
...
CREATE TABLE `nhan_vien` (
  ...
  `dia_chi` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `sdt` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `ten_nhan_vien` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `ma_tai_khoan` bigint DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `sinh_vien` (
  ...
  `bac_dao_tao` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `co_so` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  ...
  `noi_sinh` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `sdt` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `tot_nghiep` bit(1) NOT NULL,
  `ma_lop_danh_nghia` bigint NOT NULL,
  `ma_tai_khoan` bigint DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `sinh_vien` (`ma_sinh_vien`, `avatar`, `cccd`, `bac_dao_tao`, `co_so`, `loai_hinh_dao_tao`, `dia_chi`, `gioi_tinh`, `ho_ten`, `ngay_sinh`, `ngay_vao_truong`, `noi_sinh`, `sdt`, `tot_nghiep`, `ma_lop_danh_nghia`, `ma_tai_khoan`) VALUES
(1, 'https://res.cloudinary.com/dopzctbyo/image/upload/v1649587847/sample.jpg', '079201030774', NULL, NULL, NULL, '60/122 KP8 Phường TCH Quận 12 HCM', 'NAM', 'Học Sinh A', '2020-01-01', '2019-01-01', 'HỒ CHÍ MINH', '0338188506', b'0', 1, 4);
...
(1, b'0', '2023-01-18', 1, 1),
(2, b'0', '2023-01-20', 2, 1),
(3, b'0', '2023-01-23', 8, 1);
...
CREATE TABLE `thoi_khoa_bieu` (
  `ma_thoi_khoa_bieu` bigint NOT NULL,
  `chung_with_ma_thoi_khoa_bieu` bigint NOT NULL,
  `den_tiet_hoc` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `ghi_chu` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `loai_buoi_hoc` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `ngay_bat_dau` date DEFAULT NULL,
  `ngay_ket_thuc` date DEFAULT NULL,
  `nhom_hoc` int NOT NULL,
  `phong_hoc` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `thi` bit(1) NOT NULL,
  `thu_hoc` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `tu_tiet_hoc` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `ma_lop_hoc_phan` bigint NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(1, 0, 'T5', '', 'LT', '2023-01-20', '2023-01-31', 0, 'B2.01', b'0', 'T2', 'T1', 1),
(2, 0, 'T15', '', 'LT', '2023-01-10', '2023-01-26', 0, 'A7.05', b'0', 'T4', 'T13', 2),
(3, 0, 'T6', '', 'LT', '2023-01-11', '2023-01-11', 0, 'B1.02', b'0', 'T6', 'T4', 3),
(4, 0, 'T3', '', 'LT', '2023-01-12', '2023-01-30', 0, 'B1.03', b'0', 'T2', 'T1', 4),
(5, 0, 'T12', '', 'LT', '2023-02-03', '2023-02-28', 0, 'B1.01', b'0', 'CN', 'T10', 8);
...
(1, 'eyJhbGciOiJIUzUxMiJ9.eyJzdWIiOiJndjEiLCJleHAiOjE2NzQ2NzQyMTksImlhdCI6MTY3NDY1NjIxOX0.SforGuGiWNbeyy5m-Bv-sppmzhWzAI-CHkvDQXbYxMeJILQ61qdkH0mnYA1lbSFcspKdmsXa-Onv1j8jR5iADQ', '2023-01-18 17:07:46', 1),
(2, 'eyJhbGciOiJIUzUxMiJ9.eyJzdWIiOiJudjEiLCJleHAiOjE2NzQ2NzQwMDEsImlhdCI6MTY3NDY1NjAwMX0.Yab-KFUnERPgCTldomQjzQ1SV0qb5UHIk9iXh6heAXoVdVp5815beTFZpr7LTTnJ5rJwSRHzf-qsqqwXbGv6yA', '2023-01-18 17:18:14', 2),
(3, 'eyJhbGciOiJIUzUxMiJ9.eyJzdWIiOiJzdjEiLCJleHAiOjE2NzQ2NzIwOTQsImlhdCI6MTY3NDY1NDA5NH0.lNtCfhPLwRKvPmYHyWy1kgN1h_zEX6d9mA6DnhvGeiiPHnqeGG0F4jvYBRk54Z2oUZ3zVCiRFu17VitRFlTaIA', '2023-01-18 17:24:05', 4);
...
--
ALTER TABLE `diem`
  MODIFY `ma_diem` bigint NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=31;

--
-- AUTO_INCREMENT for table `giao_vien`
--
ALTER TABLE `giao_vien`
  MODIFY `ma_giao_vien` bigint NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `hoc_ky`
--
ALTER TABLE `hoc_ky`
  MODIFY `ma_hoc_ky` bigint NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;

--
-- AUTO_INCREMENT for table `khoa`
--
ALTER TABLE `khoa`
  MODIFY `ma_khoa` bigint NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;

--
-- AUTO_INCREMENT for table `khoa_hoc`
--
ALTER TABLE `khoa_hoc`
  MODIFY `ma_khoa_hoc` bigint NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;

--
-- AUTO_INCREMENT for table `lop_hoc_danh_nghia`
--
ALTER TABLE `lop_hoc_danh_nghia`
  MODIFY `ma_lop` bigint NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `lop_hoc_phan`
--
ALTER TABLE `lop_hoc_phan`
  MODIFY `ma_lop_hoc_phan` bigint NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;

--
-- AUTO_INCREMENT for table `nganh`
--
ALTER TABLE `nganh`
  MODIFY `ma_nganh` bigint NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=39;

--
-- AUTO_INCREMENT for table `nhan_vien`
--
ALTER TABLE `nhan_vien`
  MODIFY `ma_nhan_vien` bigint NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `phieu_thu`
  MODIFY `ma_phieu_thu` bigint NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `sinh_vien`
  MODIFY `ma_sinh_vien` bigint NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `thoi_khoa_bieu`
  MODIFY `ma_thoi_khoa_bieu` bigint NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT for table `thong_bao_khoa`
--
ALTER TABLE `thong_bao_khoa`
  MODIFY `ma_thong_bao` bigint NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
