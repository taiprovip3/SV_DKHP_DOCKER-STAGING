...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 27, 2023 at 05:07 AM
...
CREATE TABLE `cong_no` (
  ...
  `trang_thai` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
...
(1, 0, 5, 6, -1, 5.3, 3.4, 8.5, 0.1, 7.8, 9, 0, NULL, b'1', NULL, 1, 1);
...
CREATE TABLE `hoc_ky` (
  ...
  `so_tin_chi` int(11) NOT NULL COMMENT 'là tổng số tín chỉ bắt buộc cần đạt trong học kỳ này (dùng để tính toán cho số tín chỉ Required & số TC Optional)',
...
(1, 'eyJhbGciOiJIUzUxMiJ9.eyJzdWIiOiJndjEiLCJleHAiOjE2NzQyMDM2MjUsImlhdCI6MTY3NDE4NTYyNX0.0gtrX0cIqwljcb-np1MNsr4DTeOgAcWVoRJtnVkVo8FzKfihYlh1Tqki30jrpL6R54rzGGejD_vjMTtMVnRTJQ', '2023-01-18 17:07:46', 1),
(2, 'eyJhbGciOiJIUzUxMiJ9.eyJzdWIiOiJudjEiLCJleHAiOjE2NzQ4MDgxOTgsImlhdCI6MTY3NDc5MDE5OH0.Ch9nxgnF--XGC6wH2ymkGNWAFduKaORafu7PQpxb056tH-etF_QyBAHnpvZFwGmg1iANsydHrhkOJN6OeBEHTw', '2023-01-18 17:18:14', 2),
(3, 'eyJhbGciOiJIUzUxMiJ9.eyJzdWIiOiJzdjEiLCJleHAiOjE2NzQ4MDQ1NzYsImlhdCI6MTY3NDc4NjU3Nn0.w2GHy6CS-JDm5qEhDDCcOrjCYZi2ZI_HPy8lxWTaGT7H35iFr0nPk2mr7MKEugdUAIWh6SLoow2B8Ix72I1e8A', '2023-01-18 17:24:05', 4);
...
--
ALTER TABLE `diem`
  MODIFY `ma_diem` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=30;
...
--
ALTER TABLE `phieu_thu`
  MODIFY `ma_phieu_thu` bigint(20) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `thoi_khoa_bieu`
  MODIFY `ma_thoi_khoa_bieu` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
