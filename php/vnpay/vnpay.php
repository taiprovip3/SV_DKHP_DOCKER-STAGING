...
<body>
    <div class="container-fluid">
        <div class="row">
            <div class="col-12">
                <form action="./vnpay_create_payment.php" method="post" id="frmCreateOrder">
                    ...
                    <div class="form-group d-none">
                        ...
                        <input class="form-control" data-val="true" data-val-number="The field Amount must be a number." data-val-required="The Amount field is required." id="amount" max="100000000" min="1" name="amount" type="number" value="<?php echo $total_payment; ?>" />
                    </div>
                    ...
                    <?php
                        foreach ($total_debt as $key => $value) {
                            echo '<input hidden name="debt'.$key.'" value="'. $value .'" />';
                        }
                        echo '<input hidden name="lengthDebt" value="'.count($total_debt).'" />';
                        echo '<input hidden name="maSinhVien" value="'.$maSinhVien.'" />';
                        echo '<input hidden name="total_payment" value="'.$total_payment.'" />';
                        echo '<input hidden name="method_payment" value="'.$method_payment.'" />';
