            ...
            <div class="col-12">
                <form action="./vnpay-mobile-implements.php" method="post" id="frmCreateOrder">
                    ...
                    <div class="form-group d-none">
                        ...
                        <input class="form-control" data-val="true" data-val-number="The field Amount must be a number." data-val-required="The Amount field is required." id="amount" max="100000000" min="1" name="amount" type="number" value="<?php echo $soTien; ?>" />
                    </div>
                    ...
                    <p>Tổng thanh toán:</p>
                    <p class="fw-bold fs-3 text-decoration-underline"><?php echo number_format($soTien).'đ'; ?></p>

                    <?php
                        echo '<input hidden name="maThanhToanGiaoDich" value="'.$maThanhToanGiaoDich.'" />';
                        echo '<input hidden name="maSinhVien" value="'.$maSinhVien.'" />';
                        echo '<input hidden name="maCongNo" value="'.$maCongNo.'" />';
